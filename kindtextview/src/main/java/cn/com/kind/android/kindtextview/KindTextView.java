package cn.com.kind.android.kindtextview;
 ...
 */
public class KindTextView extends RelativeLayout {
...
//    private boolean mRightBottomTextBold;
    ...
    private OnKindTextViewClickListener KindTextViewClickListener;
    ...
    public KindTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KindTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void getAttr(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.KindTextView);

        /////////////////////////////////////////////////
        mLeftTextString = typedArray.getString(R.styleable.KindTextView_sLeftTextString);
        mLeftTopTextString = typedArray.getString(R.styleable.KindTextView_sLeftTopTextString);
        mLeftBottomTextString = typedArray.getString(R.styleable.KindTextView_sLeftBottomTextString);

        mCenterTextString = typedArray.getString(R.styleable.KindTextView_sCenterTextString);
        mCenterTopTextString = typedArray.getString(R.styleable.KindTextView_sCenterTopTextString);
        mCenterBottomTextString = typedArray.getString(R.styleable.KindTextView_sCenterBottomTextString);

        mRightTextString = typedArray.getString(R.styleable.KindTextView_sRightTextString);
        mRightTopTextString = typedArray.getString(R.styleable.KindTextView_sRightTopTextString);
        mRightBottomTextString = typedArray.getString(R.styleable.KindTextView_sRightBottomTextString);

        //////////////////////////////////////////////////

        mLeftTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sLeftTextColor);
        mLeftTopTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sLeftTopTextColor);
        mLeftBottomTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sLeftBottomTextColor);

        mCenterTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sCenterTextColor);
        mCenterTopTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sCenterTopTextColor);
        mCenterBottomTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sCenterBottomTextColor);

        mRightTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sRightTextColor);
        mRightTopTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sRightTopTextColor);
        mRightBottomTextColor = typedArray.getColorStateList(R.styleable.KindTextView_sRightBottomTextColor);

        //////////////////////////////////////////////////


        mLeftTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftTextSize, defaultSize);
        mLeftTopTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftTopTextSize, defaultSize);
        mLeftBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftBottomTextSize, defaultSize);

        mCenterTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterTextSize, defaultSize);
        mCenterTopTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterTopTextSize, defaultSize);
        mCenterBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterBottomTextSize, defaultSize);

        mRightTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightTextSize, defaultSize);
        mRightTopTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightTopTextSize, defaultSize);
        mRightBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightBottomTextSize, defaultSize);

        //////////////////////////////////////////////////
        mLeftTopLines = typedArray.getInt(R.styleable.KindTextView_sLeftTopLines, defaultMaxLines);
        mLeftLines = typedArray.getInt(R.styleable.KindTextView_sLeftLines, defaultMaxLines);
        mLeftBottomLines = typedArray.getInt(R.styleable.KindTextView_sLeftBottomLines, defaultMaxLines);

        mCenterTopLines = typedArray.getInt(R.styleable.KindTextView_sCenterTopLines, defaultMaxLines);
        mCenterLines = typedArray.getInt(R.styleable.KindTextView_sCenterLines, defaultMaxLines);
        mCenterBottomLines = typedArray.getInt(R.styleable.KindTextView_sCenterBottomLines, defaultMaxLines);

        mRightTopLines = typedArray.getInt(R.styleable.KindTextView_sRightTopLines, defaultMaxLines);
        mRightLines = typedArray.getInt(R.styleable.KindTextView_sRightLines, defaultMaxLines);
        mRightBottomLines = typedArray.getInt(R.styleable.KindTextView_sRightBottomLines, defaultMaxLines);

        //////////////////////////////////////////////////

        mLeftTopMaxEms = typedArray.getInt(R.styleable.KindTextView_sLeftTopMaxEms, defaultMaxEms);
        mLeftMaxEms = typedArray.getInt(R.styleable.KindTextView_sLeftMaxEms, defaultMaxEms);
        mLeftBottomMaxEms = typedArray.getInt(R.styleable.KindTextView_sLeftBottomMaxEms, defaultMaxEms);

        mCenterTopMaxEms = typedArray.getInt(R.styleable.KindTextView_sCenterTopMaxEms, defaultMaxEms);
        mCenterMaxEms = typedArray.getInt(R.styleable.KindTextView_sCenterMaxEms, defaultMaxEms);
        mCenterBottomMaxEms = typedArray.getInt(R.styleable.KindTextView_sCenterBottomMaxEms, defaultMaxEms);

        mRightTopMaxEms = typedArray.getInt(R.styleable.KindTextView_sRightTopMaxEms, defaultMaxEms);
        mRightMaxEms = typedArray.getInt(R.styleable.KindTextView_sRightMaxEms, defaultMaxEms);
        mRightBottomMaxEms = typedArray.getInt(R.styleable.KindTextView_sRightBottomMaxEms, defaultMaxEms);

        ////////////////////////////////////////////////

        mLeftGravity = typedArray.getInt(R.styleable.KindTextView_sLeftViewGravity, default_Gravity);
        mCenterGravity = typedArray.getInt(R.styleable.KindTextView_sCenterViewGravity, default_Gravity);
        mRightGravity = typedArray.getInt(R.styleable.KindTextView_sRightViewGravity, default_Gravity);

        mLeftTextGravity = typedArray.getInt(R.styleable.KindTextView_sLeftTextGravity, default_text_gravity);
        mCenterTextGravity = typedArray.getInt(R.styleable.KindTextView_sCenterTextGravity, default_text_gravity);
        mRightTextGravity = typedArray.getInt(R.styleable.KindTextView_sRightTextGravity, default_text_gravity);
        ////////////////////////////////////////////////

        mLeftTvDrawableLeft = typedArray.getDrawable(R.styleable.KindTextView_sLeftTvDrawableLeft);
        mLeftTvDrawableRight = typedArray.getDrawable(R.styleable.KindTextView_sLeftTvDrawableRight);
        mCenterTvDrawableLeft = typedArray.getDrawable(R.styleable.KindTextView_sCenterTvDrawableLeft);
        mCenterTvDrawableRight = typedArray.getDrawable(R.styleable.KindTextView_sCenterTvDrawableRight);
        mRightTvDrawableLeft = typedArray.getDrawable(R.styleable.KindTextView_sRightTvDrawableLeft);
        mRightTvDrawableRight = typedArray.getDrawable(R.styleable.KindTextView_sRightTvDrawableRight);

        mTextViewDrawablePadding = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sTextViewDrawablePadding, default_Margin);
        ////////////////////////////////////////////////

        mLeftTvDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftTvDrawableWidth, -1);
        mLeftTvDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftTvDrawableHeight, -1);

        mCenterTvDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterTvDrawableWidth, -1);
        mCenterTvDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterTvDrawableHeight, -1);

        mRightTvDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightTvDrawableWidth, -1);
        mRightTvDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightTvDrawableHeight, -1);

        mLeftViewWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftViewWidth, 0);
        ///////////////////////////////////////////////
        mTopDividerLineMarginLR = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sTopDividerLineMarginLR, 0);
        mTopDividerLineMarginLeft = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sTopDividerLineMarginLeft, 0);
        mTopDividerLineMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sTopDividerLineMarginRight, 0);

        mBottomDividerLineMarginLR = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sBottomDividerLineMarginLR, 0);
        mBottomDividerLineMarginLeft = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sBottomDividerLineMarginLeft, 0);
        mBottomDividerLineMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sBottomDividerLineMarginRight, 0);
        ///////////////////////////////////////////////
        mDividerLineType = typedArray.getInt(R.styleable.KindTextView_sDividerLineType, default_Divider);
        mDividerLineColor = typedArray.getColor(R.styleable.KindTextView_sDividerLineColor, mDefaultDividerLineColor);

        mDividerLineHeight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sDividerLineHeight, dip2px(mContext, 0.5f));
        ////////////////////////////////////////////////
        mLeftViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftViewMarginLeft, default_Margin);
        mLeftViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftViewMarginRight, default_Margin);
        mCenterViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterViewMarginLeft, 0);
        mCenterViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterViewMarginRight, 0);
        mRightViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightViewMarginLeft, default_Margin);
        mRightViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightViewMarginRight, default_Margin);
        ///////////////////////////////////////////////
        leftIconWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftIconWidth, 0);
        leftIconHeight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftIconHeight, 0);

        rightIconWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightIconWidth, 0);
        rightIconHeight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightIconHeight, 0);

        leftIconMarginLeft = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sLeftIconMarginLeft, default_Margin);
        rightIconMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightIconMarginRight, default_Margin);

        leftIconRes = typedArray.getDrawable(R.styleable.KindTextView_sLeftIconRes);
        rightIconRes = typedArray.getDrawable(R.styleable.KindTextView_sRightIconRes);
        ////////////////////////由于自定义方法数达到最大限度128个，暂时关闭不常用属性改为代码控制//////////////////////
//        mLeftTopTextBold = typedArray.getBoolean(R.styleable.KindTextView_sLeftTopTextIsBold, false);
//        mLeftTextBold = typedArray.getBoolean(R.styleable.KindTextView_sLeftTextIsBold, false);
//        mLeftBottomTextBold = typedArray.getBoolean(R.styleable.KindTextView_sLeftBottomTextIsBold, false);
//
//        mCenterTopTextBold = typedArray.getBoolean(R.styleable.KindTextView_sCenterTopTextIsBold, false);
//        mCenterTextBold = typedArray.getBoolean(R.styleable.KindTextView_sCenterTextIsBold, false);
//        mCenterBottomTextBold = typedArray.getBoolean(R.styleable.KindTextView_sCenterBottomTextIsBold, false);
//
//        mRightTopTextBold = typedArray.getBoolean(R.styleable.KindTextView_sRightTopTextIsBold, false);
//        mRightTextBold = typedArray.getBoolean(R.styleable.KindTextView_sRightTextIsBold, false);
//        mRightBottomTextBold = typedArray.getBoolean(R.styleable.KindTextView_sRightBottomTextIsBold, false);

        mLeftTextBackground = typedArray.getDrawable(R.styleable.KindTextView_sLeftTextBackground);
        mCenterTextBackground = typedArray.getDrawable(R.styleable.KindTextView_sCenterTextBackground);
        mRightTextBackground = typedArray.getDrawable(R.styleable.KindTextView_sRightTextBackground);

        //////////////////////////////////////////////
        useRipple = typedArray.getBoolean(R.styleable.KindTextView_sUseRipple, true);
        mBackground_drawable = typedArray.getDrawable(R.styleable.KindTextView_sBackgroundDrawableRes);
        ///////////////////////////////////////////////
        mRightViewType = typedArray.getInt(R.styleable.KindTextView_sRightViewType, -1);
        ////////////////////////////////////////////////
        isChecked = typedArray.getBoolean(R.styleable.KindTextView_sIsChecked, false);
        rightCheckBoxMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightCheckBoxMarginRight, default_Margin);
        rightCheckBoxBg = typedArray.getDrawable(R.styleable.KindTextView_sRightCheckBoxRes);
        //////////////////////////////////////////////////
        rightSwitchMarginRight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sRightSwitchMarginRight, default_Margin);
        switchIsChecked = typedArray.getBoolean(R.styleable.KindTextView_sSwitchIsChecked, false);
        mTextOff = typedArray.getString(R.styleable.KindTextView_sTextOff);
        mTextOn = typedArray.getString(R.styleable.KindTextView_sTextOn);

        mSwitchMinWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sSwitchMinWidth, 0);
        mSwitchPadding = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sSwitchPadding, 0);
        mThumbTextPadding = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sThumbTextPadding, 0);

        mThumbResource = typedArray.getDrawable(R.styleable.KindTextView_sThumbResource);
        mTrackResource = typedArray.getDrawable(R.styleable.KindTextView_sTrackResource);

        centerSpaceHeight = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sCenterSpaceHeight, dip2px(mContext, 5));
        ////////////////////////////////////////////////////
        selectorPressedColor = typedArray.getColor(R.styleable.KindTextView_sShapeSelectorPressedColor, defaultShapeColor);
        selectorNormalColor = typedArray.getColor(R.styleable.KindTextView_sShapeSelectorNormalColor, defaultShapeColor);

        solidColor = typedArray.getColor(R.styleable.KindTextView_sShapeSolidColor, defaultShapeColor);

        cornersRadius = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeCornersRadius, 0);
        cornersTopLeftRadius = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeCornersTopLeftRadius, 0);
        cornersTopRightRadius = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeCornersTopRightRadius, 0);
        cornersBottomLeftRadius = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeCornersBottomLeftRadius, 0);
        cornersBottomRightRadius = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeCornersBottomRightRadius, 0);

        strokeWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeStrokeWidth, 0);
        strokeDashWidth = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeStrokeDashWidth, 0);
        strokeDashGap = typedArray.getDimensionPixelSize(R.styleable.KindTextView_sShapeStrokeDashGap, 0);

        strokeColor = typedArray.getColor(R.styleable.KindTextView_sShapeStrokeColor, defaultShapeColor);

        useShape = typedArray.getBoolean(R.styleable.KindTextView_sUseShape, false);
        mLeftIconShowCircle = typedArray.getBoolean(R.styleable.KindTextView_sLeftIconShowCircle, false);
        mRightIconShowCircle = typedArray.getBoolean(R.styleable.KindTextView_sRightIconShowCircle, false);
...
//        setDefaultTextIsBold(rightView, mRightTopTextBold, mRightTextBold, mRightBottomTextBold);
     ...
     * @return 方便链式调用
     */
    public KindTextView setLeftTopString(CharSequence string) {
        if (leftView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setLeftString(CharSequence string) {
        if (leftView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setLeftBottomString(CharSequence string) {
        if (leftView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setCenterTopString(CharSequence string) {
        if (centerView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setCenterString(CharSequence string) {
        if (centerView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setCenterBottomString(CharSequence string) {
        if (centerView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setRightTopString(CharSequence string) {
        if (rightView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setRightString(CharSequence string) {
        if (rightView != null) {
     ...
     * @return 方便链式调用
     */
    public KindTextView setRightBottomString(CharSequence string) {
        if (rightView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setLeftTopTextColor(int color) {
     ...
     * @return KindTextView
     */
    public KindTextView setLeftTopTextColor(ColorStateList color) {
        if (leftView != null) {
            if (color == null) {
     ...
     * @return KindTextView
     */
    public KindTextView setLeftTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setLeftTextColor(ColorStateList color) {
        if (leftView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setLeftBottomTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setLeftBottomTextColor(ColorStateList color) {
        if (leftView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setCenterTopTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setCenterTopTextColor(ColorStateList color) {
        if (centerView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setCenterTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setCenterTextColor(ColorStateList color) {
        if (centerView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setCenterBottomTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setCenterBottomTextColor(ColorStateList color) {
        if (centerView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setRightTopTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setRightTopTextColor(ColorStateList color) {
        if (rightView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setRightTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setRightTextColor(ColorStateList color) {
        if (rightView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setRightBottomTextColor(int color) {
        ColorStateList colorStateList = ColorStateList.valueOf(color);
     ...
     * @return KindTextView
     */
    public KindTextView setRightBottomTextColor(ColorStateList color) {
        if (rightView != null) {
            if (color == null) {
                throw new NullPointerException();
            }
     ...
     * @return KindTextView
     */
    public KindTextView setLeftTopTextIsBold(boolean isBold) {
        if (leftView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setLeftTextIsBold(boolean isBold) {
        if (leftView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setLeftBottomTextIsBold(boolean isBold) {
        if (leftView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setCenterTopTextIsBold(boolean isBold) {
        if (centerView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setCenterTextIsBold(boolean isBold) {
        if (centerView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setCenterBottomTextIsBold(boolean isBold) {
        if (centerView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setRightTopTextIsBold(boolean isBold) {
        if (rightView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setRightTextIsBold(boolean isBold) {
        if (rightView != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setRightBottomTextIsBold(boolean isBold) {
        if (rightView != null) {
     ...
     * @return 返回值
     */
    public KindTextView setCbChecked(boolean checked) {
        isChecked = checked;
        if (rightCheckBox != null) {
     ...
     * @return 返回值
     */
    public KindTextView setCbClickable(boolean clickable) {
        if (rightCheckBox != null) {
     ...
     * @return 返回对象
     */
    public KindTextView setCbBackground(Drawable drawable) {
     ...
     * @return 返回值
     */
    public KindTextView setSwitchIsChecked(boolean checked) {
     ...
     * @return 返回值
     */
    public KindTextView setSwitchClickable(boolean clickable) {
        if (mSwitch != null) {
     ...
     */
    public KindTextView setLeftTvDrawableLeft(Drawable drawableLeft) {
     ...
     */
    public KindTextView setLeftTvDrawableRight(Drawable drawableRight) {
     ...
     * @param drawableLeft 左边图片资源
     */
    public KindTextView setCenterTvDrawableLeft(Drawable drawableLeft) {
     ...
     * @param drawableRight 右边图片资源
     */
    public KindTextView setCenterTvDrawableRight(Drawable drawableRight) {
     ...
     * @param drawableLeft 左边图片资源
     */
    public KindTextView setRightTvDrawableLeft(Drawable drawableLeft) {
     ...
     * @param drawableRight 右边图片资源
     */
    public KindTextView setRightTvDrawableRight(Drawable drawableRight) {
     ...
     * @return 返回对象
     */
    public KindTextView setLeftIcon(Drawable leftIcon) {
        if (leftIconIV != null) {
            leftImgParams.setMargins(leftIconMarginLeft, 0, 0, 0);
     ...
     * @return 返回对象
     */
    public KindTextView setLeftIcon(int resId) {
        if (leftIconIV != null) {
            leftImgParams.setMargins(leftIconMarginLeft, 0, 0, 0);
     ...
     * @return 返回对象
     */
    public KindTextView setRightIcon(Drawable rightIcon) {
        if (rightIconIV != null) {
            rightImgParams.setMargins(0, 0, rightIconMarginRight, 0);
     ...
     * @return 返回对象
     */
    public KindTextView setRightIcon(int resId) {
        if (rightIconIV != null) {
            rightImgParams.setMargins(0, 0, rightIconMarginRight, 0);
     ...
     * @return 对象
     */
    public KindTextView setSBackground(Drawable drawable) {
        if (drawable != null) {
     ...
     * @return KindTextView
     */
    public KindTextView setLeftTextGravity(int gravity) {
     ...
     * @return KindTextView
     */
    public KindTextView setCenterTextGravity(int gravity) {
     ...
     * @return KindTextView
     */
    public KindTextView setRightTextGravity(int gravity) {
     ...
     * @return this
     */
    public KindTextView setDividerLineType(int dividerType) {
        mDividerLineType = dividerType;
        invalidate();
        return this;
    }

    public KindTextView setTopDividerLineColor(int lineColor) {
        mTopDividerPaint.setColor(lineColor);
        invalidate();
        return this;
    }

    public KindTextView setBottomDividerLineColor(int lineColor) {
     ...
     * 点击事件
     *
     * @param onKindTextViewClickListener ClickListener
     * @return KindTextView
     */
    public KindTextView setOnKindTextViewClickListener(OnKindTextViewClickListener onKindTextViewClickListener) {
        this.KindTextViewClickListener = onKindTextViewClickListener;
        if (KindTextViewClickListener != null) {
            this.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    KindTextViewClickListener.onClickListener(KindTextView.this);
                }
            });
        }
        return this;
    ...
    public KindTextView setLeftTopTvClickListener(OnLeftTopTvClickListener leftTopTvClickListener) {
        this.leftTopTvClickListener = leftTopTvClickListener;
        setDefaultLeftViewClickListener(leftView);
        return this;
    }

    public KindTextView setLeftTvClickListener(OnLeftTvClickListener leftTvClickListener) {
        this.leftTvClickListener = leftTvClickListener;
        setDefaultLeftViewClickListener(leftView);
        return this;
    }

    public KindTextView setLeftBottomTvClickListener(OnLeftBottomTvClickListener leftBottomTvClickListener) {
        this.leftBottomTvClickListener = leftBottomTvClickListener;
        setDefaultLeftViewClickListener(leftView);
        return this;
    }

    public KindTextView setCenterTopTvClickListener(OnCenterTopTvClickListener centerTopTvClickListener) {
        this.centerTopTvClickListener = centerTopTvClickListener;
        setDefaultCenterViewClickListener(centerView);
        return this;
    }

    public KindTextView setCenterTvClickListener(OnCenterTvClickListener centerTvClickListener) {
        this.centerTvClickListener = centerTvClickListener;
        setDefaultCenterViewClickListener(centerView);
        return this;
    }

    public KindTextView setCenterBottomTvClickListener(OnCenterBottomTvClickListener centerBottomTvClickListener) {
        this.centerBottomTvClickListener = centerBottomTvClickListener;
        setDefaultCenterViewClickListener(centerView);
        return this;
    }

    public KindTextView setRightTopTvClickListener(OnRightTopTvClickListener rightTopTvClickListener) {
        this.rightTopTvClickListener = rightTopTvClickListener;
        setDefaultRightViewClickListener(rightView);
        return this;
    }

    public KindTextView setRightTvClickListener(OnRightTvClickListener rightTvClickListener) {
        this.rightTvClickListener = rightTvClickListener;
        setDefaultRightViewClickListener(rightView);
        return this;
    }

    public KindTextView setRightBottomTvClickListener(OnRightBottomTvClickListener rightBottomTvClickListener) {
        this.rightBottomTvClickListener = rightBottomTvClickListener;
        setDefaultRightViewClickListener(rightView);
        return this;
    }

    public KindTextView setLeftImageViewClickListener(OnLeftImageViewClickListener listener) {
    ...
    public KindTextView setRightImageViewClickListener(final OnRightImageViewClickListener listener) {
    ...
    public KindTextView setSwitchCheckedChangeListener(OnSwitchCheckedChangeListener switchCheckedChangeListener) {
        this.switchCheckedChangeListener = switchCheckedChangeListener;
        return this;
    }

    public KindTextView setCheckBoxCheckedChangeListener(OnCheckBoxCheckedChangeListener checkBoxCheckedChangeListener) {
        this.checkBoxCheckedChangeListener = checkBoxCheckedChangeListener;
        return this;
    }

    public KindTextView setLeftTextGroupClickListener(final OnLeftTextGroupClickListener leftTextGroupClickListener) {
    ...
    public KindTextView setCenterTextGroupClickListener(final OnCenterTextGroupClickListener centerTextGroupClickListener) {
    ...
    public KindTextView setRightTextGroupClickListener(final OnRightTextGroupClickListener rightTextGroupClickListener) {
    ...
    ////////////////////////////////////////////////////////////////////////////////////
    public interface OnKindTextViewClickListener {
        void onClickListener(KindTextView KindTextView);
    }
